...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          Image.asset('assets/logo1.png', height: 100, width: 100, fit: BoxFit.contain), // Replace with your image asset
          _buildSettingsItem('Account', () {/* Navigate to Account page */}),
          _buildSettingsItem('Password Manager', () {/* Navigate to Password Manager page */}),
          _buildSettingsItem('Notifications', () {/* Navigate to Notifications page */}),
          _buildSettingsItem('Security and Privacy', () {/* Navigate to Security and Privacy page */}),
          _buildSettingsItem('Theme', () {/* Navigate to Theme page */}),
          _buildSettingsItem('Logout', () {/* Handle logout */}),
        ],
      ),
